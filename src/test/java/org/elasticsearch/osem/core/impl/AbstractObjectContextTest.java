...
public class AbstractObjectContextTest {
    protected AttributeSource createAttributes() {
        return new AttributeSourceImpl();
    }
    protected PropertySignatureSource createSignatures() {
        return new PropertySignatureSourceImpl();
    }
